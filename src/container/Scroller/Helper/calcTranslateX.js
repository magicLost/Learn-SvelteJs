...
class CalcTranslateX {
    ...
    setValues = (listRef, itemRef, numberOfItems) => {
        ...
        this.listWidth = listRef.getBoundingClientRect().width;
        this.itemWidth = itemRef.getBoundingClientRect().width;
    ...
    onPointerDown = (pageX, pageY, listRef) => {
        ...
        this.translateX = listRef.getBoundingClientRect().x -  Math.abs(this.offsetX);
